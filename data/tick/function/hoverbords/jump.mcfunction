...
#execute if score #air_blocks var matches 8..10 run say 8..10
...
#execute if score #air_blocks var matches 3..7 run say 3..7
...
#execute if score #air_blocks var matches ..2 run say ..2
